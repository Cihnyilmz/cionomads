      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] text-[12px] font-normal leading-[16.68px] text-white sm:text-[18px] sm:leading-[22.68px]">
            Fellow Digital Nomad
          </p>
        </div>

        <p className="mt-[24px] text-[18px] font-normal leading-[39.6px] text-white sm:text-[24px] sm:leading-[45.6px]">
          “Digital nomadism is the ultimate fusion of work and travel, a
          lifestyle that empowers us to explore the world while staying
          connected and productive. It's about embracing freedom, adventure, and
          the thrill of charting your own path.”
        </p>
      </motion.div>
